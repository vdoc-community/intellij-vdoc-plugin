...
public class VDocRunConfigurationType extends ConfigurationTypeBase
{
	...
	public static final String VDOC_RUN_CONFIGURATION_NAME = "Process";
	
	
	public VDocRunConfigurationType(){
		super(VDOC_RUN_CONFIGURATION_ID, VDOC_RUN_CONFIGURATION_NAME, VDOC_RUN_CONFIGURATION_NAME, new ImageIcon(VDocRunConfigurationType.class.getResource("/images/icon/icon16x16.png")));
