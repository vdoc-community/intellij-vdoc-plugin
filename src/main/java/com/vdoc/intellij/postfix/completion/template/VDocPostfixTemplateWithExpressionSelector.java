...
public abstract class VDocPostfixTemplateWithExpressionSelector extends PostfixTemplateWithExpressionSelector {
	public static final Condition<PsiElement> IS_MODULE = element -> InheritanceUtil.isInheritor(((PsiExpression)element).getType(), "com.axemble.vdoc.sdk.modules.IModule");
	public static final Condition<PsiElement> IS_STRING = element -> InheritanceUtil.isInheritor(((PsiExpression)element).getType(), "java.lang.String");
